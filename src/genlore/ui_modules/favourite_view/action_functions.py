...
def load_qlist_items(cls: Ui_Favourite_View_Application_Panel):
    db_context = Db_Module.get_instance()
    story_entries = db_context.get_favourite_entries("STORY")
    summary_entries = db_context.get_favourite_entries("SUMMARY")
