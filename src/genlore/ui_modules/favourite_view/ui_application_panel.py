...
class Ui_Favourite_View_Application_Panel(QWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.prev_coords = None
        self.full_screened = False
        self.setObjectName("Ui_Favourite_View_Application_Panel")
        self.load_widgets()
        self.set_layout()
        self.load_widget_assets()

        with open("src/genlore/ui_modules/favourite_view/ui_application_panel.qss", "r") as qss_file:
...
if __name__ == "__main__":
    app = QApplication()
    window = Ui_Favourite_View_Application_Panel()
    window.show()
    app.exec()
