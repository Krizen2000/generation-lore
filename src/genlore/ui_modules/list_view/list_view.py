from src.genlore.ui_modules.list_view.ui_action_panel import Ui_List_View_Action_Panel
from src.genlore.ui_modules.list_view.ui_application_panel import Ui_List_View_Application_Panel
from src.genlore.ui_modules.doc_gen_view.action_functions import *
from src.genlore.ui_modules.list_view.action_functions import *
...
class List_View:
    ...
    def load_recent_view_ui(self):
        self.ui_action_panel = Ui_List_View_Action_Panel(self.action_panel)
        self.ui_application_panel = Ui_List_View_Application_Panel(self.application_panel)
    ...
    def set_view_buttons(self,set_focus_recent_view,set_focus_favourite_view):
